    ...
    private drawTips() {
        ...
        function drawText(index: number, self: any) {
            ...
            if (self.buffer[index].entries[0].label) {
                ...
                let textLength: number = self.canv.measureText(self.buffer[index].entries[0].label)
...
class TreemapTransition {
    ...
    private play = false
    private origin = null // deprecated
    private centerIndex = null // deprecated
    private originItem = null // deprecated
